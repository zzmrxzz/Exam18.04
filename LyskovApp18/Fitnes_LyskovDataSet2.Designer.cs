...
namespace LyskovApp18 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("Fitnes_LyskovDataSet2")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class Fitnes_LyskovDataSet2 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected Fitnes_LyskovDataSet2(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            Fitnes_LyskovDataSet2 cln = ((Fitnes_LyskovDataSet2)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "Fitnes_LyskovDataSet2";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Fitnes_LyskovDataSet2.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            Fitnes_LyskovDataSet2 ds = new Fitnes_LyskovDataSet2();
        ...
        public partial class КлиентыDataTable : global::System.Data.TypedTableBase<КлиентыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public КлиентыRow AddКлиентыRow(string Фамилия, string Имя, string Отчество, string Телефон, int Код_услуги, int Код_дополнительной_услуги, int Код_сотрудника) {
...
namespace LyskovApp18.Fitnes_LyskovDataSet2TableAdapters {
    ...
    public partial class КлиентыTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Клиенты] ([Фамилия], [Имя], [Отчество], [Телефон], [Код услуги], [Код дополнительной услуги], [Код сотрудника]) VALUES (@Фамилия, @Имя, @Отчество, @Телефон, @Код_услуги, @Код_дополнительной_услуги, @Код_сотрудника);
SELECT [Код клиента], Фамилия, Имя, Отчество, Телефон, [Код услуги], [Код дополнительной услуги], [Код сотрудника] FROM Клиенты WHERE ([Код клиента] = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Клиенты] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Телефон] = @Телефон, [Код услуги] = @Код_услуги, [Код дополнительной услуги] = @Код_дополнительной_услуги, [Код сотрудника] = @Код_сотрудника WHERE (([Код клиента] = @Original_Код_клиента) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ([Отчество] = @Original_Отчество) AND ([Телефон] = @Original_Телефон) AND ([Код услуги] = @Original_Код_услуги) AND ([Код дополнительной услуги] = @Original_Код_дополнительной_услуги) AND ((@IsNull_Код_сотрудника = 1 AND [Код сотрудника] IS NULL) OR ([Код сотрудника] = @Original_Код_сотрудника)));
SELECT [Код клиента], Фамилия, Имя, Отчество, Телефон, [Код услуги], [Код дополнительной услуги], [Код сотрудника] FROM Клиенты WHERE ([Код клиента] = @Код_клиента)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Код клиента], Фамилия, Имя, Отчество, Телефон, [Код услуги], [Код дополни" +
                "тельной услуги], [Код сотрудника] FROM dbo.Клиенты";
        ...
        public virtual int Fill(Fitnes_LyskovDataSet2.КлиентыDataTable dataTable) {
        ...
        public virtual Fitnes_LyskovDataSet2.КлиентыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Fitnes_LyskovDataSet2.КлиентыDataTable dataTable = new Fitnes_LyskovDataSet2.КлиентыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Fitnes_LyskovDataSet2.КлиентыDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Fitnes_LyskovDataSet2 dataSet) {
        ...
        public virtual int Delete(int Original_Код_клиента, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Телефон, int Original_Код_услуги, int Original_Код_дополнительной_услуги, global::System.Nullable<int> Original_Код_сотрудника) {
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, string Телефон, int Код_услуги, int Код_дополнительной_услуги, global::System.Nullable<int> Код_сотрудника) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(
                    ...
                    int Original_Код_дополнительной_услуги, 
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_Код_услуги));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_Код_дополнительной_услуги));
            if ((Original_Код_сотрудника.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Телефон, int Код_услуги, int Код_дополнительной_услуги, global::System.Nullable<int> Код_сотрудника, int Original_Код_клиента, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Телефон, int Original_Код_услуги, int Original_Код_дополнительной_услуги, global::System.Nullable<int> Original_Код_сотрудника) {
            return this.Update(Фамилия, Имя, Отчество, Телефон, Код_услуги, Код_дополнительной_услуги, Код_сотрудника, Original_Код_клиента, Original_Фамилия, Original_Имя, Original_Отчество, Original_Телефон, Original_Код_услуги, Original_Код_дополнительной_услуги, Original_Код_сотрудника, Original_Код_клиента);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(Fitnes_LyskovDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(Fitnes_LyskovDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(Fitnes_LyskovDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(Fitnes_LyskovDataSet2 dataSet) {
            if ((dataSet == null)) {
